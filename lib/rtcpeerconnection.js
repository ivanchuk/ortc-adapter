...
/**
 * onSuccess callback for {@link RTCPeerConnection.createAnswer}
 * @callback onCreateAnswerSuccess
 * @param {RTCSessionDescription}
 *//**
 * Construct an {@link RTCSessionDescription} containing an SDP offer.
 * @param {onCreateAnswerSuccess} onSuccess
 * @param {function} onFailure
 *//**
 * Construct an {@link RTCSessionDescription} containing an SDP offer.
...
/**
 * onSuccess callback for {@link RTCPeerConnection.createOffer}
 * @callback onCreateOfferSuccess
 * @param {RTCSessionDescription}
 *//**
 * Construct an {@link RTCSessionDescription} containing an SDP offer.
 * @param {onCreateOfferSuccess} onSuccess
 * @param {function} onFailure
